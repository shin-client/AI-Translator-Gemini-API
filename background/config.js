const config = {
    ...
    API_STATUS_INVALID_TOOLTIP: chrome.i18n.getMessage('API_STATUS_INVALID_TOOLTIP'),
    SELECTED_TEXT_LANGUAGE_LABEL: chrome.i18n.getMessage('SELECTED_TEXT_LANGUAGE_LABEL'),
    ...
    UI_TEXT: {
        ...
        TRANSLATION_IN_PROGRESS: chrome.i18n.getMessage('TRANSLATION_IN_PROGRESS_MESSAGE'),
        TRANSLATION_COMPLETE: chrome.i18n.getMessage('TRANSLATION_COMPLETE_MESSAGE'),
        API_KEY_NOT_SET: chrome.i18n.getMessage('API_KEY_NOT_SET_MESSAGE'),
        TEXT_TO_TRANSLATE_EMPTY: chrome.i18n.getMessage('TEXT_TO_TRANSLATE_EMPTY_MESSAGE'),
